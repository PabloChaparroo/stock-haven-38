        ...
        <Table>
          ...
          <TableBody>
            {articles.map((a) => {
              ...
              const totalStock = hasVariants ? totalVariantStock(a) : a.stock;
                  ...
                  <TableRow className="hover:bg-muted/30">
                    <TableCell className="pr-0">
                      {hasVariants ? (
                        ...
                        <span className="grid h-8 w-8 place-items-center text-muted-foreground/30">
                    ...
                    <TableCell className={cn("font-semibold", low && "text-destructive")}>
                      {hasVariants ? (
                        <span className="inline-flex items-center gap-1 rounded-full bg-brand/10 px-2 py-0.5 text-navy">
                          {totalStock}
                    ...
                    <TableCell>
                      {hasVariants ? (
                        <span className="text-muted-foreground/50" title="Stock de seguridad por variante">—</span>
                      ) : (
                        ...
                        <div className="rounded-lg border bg-card p-3">
                          ...
                          {hasVariants && (
                            <div className="mt-2 flex items-center gap-1 text-xs text-muted-foreground">
                              ...
                              <span>{a.variants!.length} variantes — Stock total: <strong className="text-navy">{totalStock}</strong></span>
                            </div>
                          )}
                        </div>
                      </TableCell>
